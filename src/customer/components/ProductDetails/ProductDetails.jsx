      ...
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10 ">
          ...
          <div className="flex flex-col items-center ">
            <div className="flex justify-center items-center overflow-hidden rounded-lg max-w-[30rem] max-h-[35rem]">
              <img
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((item) => (
                <div className="object-top aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-h-[5rem] max-w-[5rem] mt-4">
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="h-full w-full object-cover object-center"
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-xl font-semibold test-gray-900 text-left">
                Universaloutfit
              </h1>
        ...
        {/* Rating and reviews */}
        <section>
          <h1 className="font-semibold text-lg pb-4 text-left pl-5">Recent Review & Rating</h1>
          <div className="border p-5 lg:mx-5">
            <Grid container spacing={7} >
              <Grid item xs={7}>
                <div className="space-y-5">
                     {[1,1,1].map((items)=> <ProductReviewCard/>) }
                </div>
              </Grid>
              <Grid item xs={5} className="text-left">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60">5400 Ratings</p>
                ...
                <Box className="mt-5 space-y-3">
                  ...
                  <Grid container  alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}} variant="determinate" value={25} color="primary"></LinearProgress>
                    </Grid>
                  </Grid>
                  <Grid container  alignItems="center" gap={2}>
                    <Grid item xs={2}>
        ...
        {/* similar products */}
        <section className="p1-10 ">
          <h1 className="mx-5 py-5 text-xl font-bold text-left">Similar Products</h1>
          <div className="flex flex-wrap justify-center spaca-y-10">
            {mensKutra.map((item)=>(
              <div className="mx-3 my-3">
                <HomeSectionCard product={item} sx={{ my: 5, mx: 5 }} />
              </div>
            ))}
          </div>
        </section>
